...
module.exports = function(passport) {
    ...
    function(req, email, password, done) { // callback with email and password from our form
        ...
        User.findOne({ 'local.email' :  email }, function(err, user) {
            ...
            if (!user)
                return done(null, false, req.flash('loginMessage', 'No account fount with that email address. Did you sign up with a different email address?')); // req.flash is the way to set flashdata using connect-flash
